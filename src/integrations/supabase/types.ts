    ...
    Tables: {
      access_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "access_logs_target_id_fkey"
            columns: ["target_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
      ...
      access_revocation_history: {
        Row: {
          access_id: string | null
          id: string
          original_shared_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "access_revocation_history_access_id_fkey"
            columns: ["access_id"]
            isOneToOne: false
      ...
      card_drop_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "card_drop_sessions_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "digital_cards"
            referencedColumns: ["id"]
      ...
      profile_access: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_access_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "digital_cards"
            referencedColumns: ["id"]
